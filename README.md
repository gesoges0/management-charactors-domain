...
## 顔パーツのパラメータ設定
<a href="http://make.girls.moe/#/">本家</a>で使われているパラメータのうち, 
髪の色(金, 茶, 黒, 青, 桃, 紫, 緑, 赤, 銀, 白, 橙), 髪型(ロング, ショート, ツインテ, ドリルヘア, ポニテ), 
目の色(青, 赤, 茶, 緑, 紫, 黄, 桃, 黒, 橙, オッドアイ), 笑顔(ON, OFF), 開口(ON, OFF), 帽子(ON, OFF), リボン(ON, OFF),
メガネ(ON, OFF)を採用. これに年代というパラメータを加えたものを作る.
